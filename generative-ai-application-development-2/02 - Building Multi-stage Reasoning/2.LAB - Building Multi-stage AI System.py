...
chain1.invoke("hair drier with mobile app control")
...
# Set OpenAI API key
os.environ["OPENAI_API_KEY"] = <FILL_IN>
...
image_url = chain2.invoke(<FILL_IN>)
...
output_html = chain3.invoke({ <FILL_IN>})
